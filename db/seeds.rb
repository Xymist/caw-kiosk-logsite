...
logos = [
  ...
  ['hi_big_e_lrg_blue-2.png',       'Big Lottery Fund',          'https://www.biglotteryfund.org.uk/',  [Jurisdiction.find_by(name: 'guildford'), Jurisdiction.find_by(name: 'waverley')]],
...
kiosk_topics = [
  ['benefits',        'Information on claiming benefits'],
  ['work',            'Work and Employment'],
  ['debt',            'Help dealing with debt'],
  ['consumer',        'Consumer Issues and Complaints'],
  ['relationships',   'Family and relationship issues'],
  ['housing',         'Housing and homelessness'],
  ['law_and_rights',  'Legal and rights issues'],
  ['discrimination',  'Unfair discrimination issues'],
  ['tax',             'Issues with taxation'],
  ['healthcare',      'Physical and mental health issues'],
  ['education',       'Education and training']
]

kiosk_topics.each do |name, description|
  k = KioskTopic.find_or_create_by(name: name)
  k.update_attributes(description: description)
end
