...
advice_pages = [
  ...
  [
    ...
    '03448487969',
    'The Citizens Advice information site', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'work'
  ],
  [
    'Gov.UK',
    'http://www.gov.uk/browse/working',
    '',
    'The Government Working Guide', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'work'
  ],
  [
    'Pension Service',
  ...
  [
    ...
    '',
    'The Government Child Maintenance Guide', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'relationships'
  ],
  [
    'Family Mediation Council',
    'http://www.familymediationcouncil.org.uk/family-mediation/choose-family-mediation/',
    '',
    'Mediation services', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'relationships'
  ],
  [
    'Relate',
    'https://www.relate.org.uk',
    '03001001234',
    'Counselling, support and mediation service', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'relationships'
  ],
  [
    'Childline',
  ...
  [
    'Rasasc',
    'http://www.rasasc.org/advice-guides/',
    '08000288022',
    'Advice and information relating to Rape and Sexual Abuse', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'relationships'
  ],
  [
    'Age UK',
    'http://www.ageuk.org.uk/health-wellbeing/relationships-and-family/',
    '08001696565',
    'Relationship advice for older people', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'relationships'
  ],
  [
    "Women's Aid",
    ...
    '08082000247',
    'Advice and assistance with domestic abuse', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'relationships'
  ],
  [
    'Citizens Advice',
    'https://www.citizensadvice.org.uk/housing/',
    '03448487969',
    'The Citizens Advice information site', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'housing'
  ],
  [
    'Step by Step',
    'http://www.stepbystep.org.uk',
    '01252346105',
    'Advice on homelessness for young people', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'housing'
  ],
  [
    'Gov.UK',
    'http://www.gov.uk/browse/housing/owning-renting-property',
    '',
    'The Government Housing Guide', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'housing'
  ],
  [
    'Age UK',
    'http://www.ageuk.org.uk/home-and-care/',
    '08001696565',
    'Housing advice for older people', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'housing'
  ],
  [
    'Shelter',
    'http://england.shelter.org.uk/get_advice',
    '',
    'Advice on homelessness in England', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'housing'
  ],
  [
    'Citizens Advice',
    'https://www.citizensadvice.org.uk/law-and-rights/',
    '03448487969',
    'The Citizens Advice information site', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'law_and_rights'
  ],
  [
    'Gov.UK',
    'https://www.gov.uk/browse/justice',
    '',
    'Government Justice Guide', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'law_and_rights'
  ],
  [
    'Gov.UK Immigration',
    'https://www.gov.uk/visa-immigration',
    '',
    'Immigration and Residency Law Guide', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'law_and_rights'
  ],
  [
    'CLS Direct Legal Service',
    'http://www.clsdirect.org.uk/',
    '',
    'Legal advice and legal aid', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'law_and_rights'
  ],
  [
    'Age UK',
    'http://www.ageuk.org.uk/money-matters/legal-issues/',
    '08001696565',
    'Legal advice for older people', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'law_and_rights'
  ],
  [
    'Power of Attorney',
    'http://www.justice.gov.uk/about/opg',
    '',
    'Advice on Powers of Attorney', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'law_and_rights'
  ],
  [
    'Citizens Advice',
    'https://www.citizensadvice.org.uk/discrimination/',
    '03448487969',
    'The Citizens Advice information site', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'discrimination'
  ],
  [
    'Age UK',
    'http://www.ageuk.org.uk/work-and-learning/discrimination-and-rights/',
    '08001696565',
    'Discrimination advice for older people', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'discrimination'
  ],
  [
    'Citizens Advice',
    'https://www.citizensadvice.org.uk/tax/',
    '03448487969',
    'Citizens Advice information site', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'tax'
  ],
  [
    'Gov.UK',
    'http://www.gov.uk/browse/tax',
    '',
    'The Government taxation guide', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'tax'
  ],
  [
    'HM Revenue & Customs',
    'http://www.hmrc.gov.uk',
    '03002003300',
    'Tax and benefits information', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'tax'
  ],
  [
    'Age UK',
    'http://www.ageuk.org.uk/money-matters/income-and-tax/',
    '08001696565',
    'Tax advice for older people', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'tax'
  ],
  [
    'TaxAid',
    'http://www.taxaid.org.uk',
    '03451203779',
    'If HMRC cannot help with a tax issue', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'tax'
  ],
  [
    'Citizens Advice',
    'https://www.citizensadvice.org.uk/healthcare/',
    '03448487969',
    'The Citizens Advice information site', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'healthcare'
  ],
  [
    'NHS Choices',
    'https://www.nhs.uk/',
    '',
    'The National Health Service', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'healthcare'
  ],
  ['Healthwatch',
    'http://www.healthwatch.co.uk',
    '03000683000',
    'The Health Service Watchdog', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'healthcare'
  ],
  ['Age UK',
    'http://www.ageuk.org.uk',
    '08001696565',
    'Health and advice for older people', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'healthcare'
  ],
  ['Mind',
    'http://www.mind.org.uk',
    '03001233393',
    'Advice and assistance with mental health issues', ["gp-godalming", "gp-farnham", "gp-cranleigh", "guildford", "ash", "waverley", "furniturelink", "ageuk"],'healthcare'
  ],
  ['Age UK',
    'http://www.ageuk.org.uk',
    '08001696565',
