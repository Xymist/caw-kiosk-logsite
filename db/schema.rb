...
ActiveRecord::Schema.define(version: 20_160_804_143_051) do
  ...
  create_table 'visits', force: :cascade do |t|
    ...
    t.index %w(time_stamp kiosk_id), name: 'index_visits_on_time_stamp_and_kiosk_id', unique: true, using: :btree
