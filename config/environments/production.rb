Rails.application.configure do
  ...
  config.action_mailer.default_url_options =
    { host: 'logserver.3rdsectorit.co.uk' }
  ...
  # Asset digests allow you to set far-future HTTP expiration dates on assets,
  ...
  # config.active_job.queue_name_prefix = "caw-kiosk-logsite_#{Rails.env}"
